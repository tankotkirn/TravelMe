...
<head>
    ...
    <title>TravelMe.com</title>
    <link rel="stylesheet" href="style.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
        href="https://fonts.googleapis.com/css2?family=Baloo+Bhai+2&family=Roboto+Slab:wght@500&family=Roboto:wght@500&family=Ubuntu&display=swap"
        rel="stylesheet">
</head>
...
<body>
    ...
    <div class="container">
        ...
        <form action="index.php" method="post">
            ...
            <select name="gender" id="gender" autocomplete="gender" enterkeyhint="done" required>
            ...
            <input type="pincode" name="pincode" id="pincode" placeholder="Enter your postal-code:" required>
        
            <label for="city">City:</label>
            <input type="city" name="city" id="city" placeholder="Enter your city:" required>
        
            <label for="state">State:</label>
            <input type="state" name="state" id="state" placeholder="Enter your state:" required>
            ...
            <textarea name="desc" id="desc" cols="30" rows="10" placeholder="Enter any other information you may want to convey here"></textarea>
        
            <button onclick="thankyou.html" class="btn" type="submit">Submit</button>
